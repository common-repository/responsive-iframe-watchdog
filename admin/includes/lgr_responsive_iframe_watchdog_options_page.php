...
//function getMyPluginFolderName( $moveUpFolderCount ){
	//return 'hello';
	//$arrayMyPluginName = explode( '/', plugin_dir_path( __FILE__ ) );
	//echo __(print_r($arrayMyPluginName));
...
function lgrriw_options_page() { 
	...
	<form action='options.php' method='post'>
		...
		<?php endif;
			...
			$pluginName = $GLOBALS[pluginName];
			echo __('My Plugin Name: ' .  $pluginName);
			
			//wp_register_script( 'lgrriw_responsive_iframe_watchdog', plugins_url( $pluginName . 'admin/js/lgr_responsive_iframe_watchdog.js' ) );
